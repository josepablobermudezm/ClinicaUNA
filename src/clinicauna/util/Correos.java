...
public class Correos {
    ...
    public String htmlRecuperarContrasenna(String contrasenna) {
        ...
        return "<!DOCTYPE html>\n"
                ...
                + " <div id=\"imagenLogo\" style=\"width: 100px; heigth: 100px;  margin-left:33%\">"
                ...
                + "					Para poder reestablecer la constraseña es necesario la siguiente clave temporal: " + contrasenna + " \n Si no has intentado reestablecer tu contraseña ignora este mensaje.</p>\n"
    ...
    public String activarUsuario(String usuario,String url) {
        return "<!DOCTYPE html>\n"
                ...
                + "<table style=\"max-width: 600px; padding: 10px; margin:0 auto; border-collapse: collapse;\">\n"
                + "	<tr>\n"
                + "		<td style=\"background-color: #cac7c7; text-align: left; padding: 0\">\n"
                + "			<a href=\"" + url + "\">\n"
                + "			</a>\n"
                + "		</td>\n"
                + "	</tr>\n"
                ...
                + "<img width=\"150px\" style=\"display:block; margin: 1.5% 3%;\" \" src=\"https://i.postimg.cc/5yGvbDXK/logo-Correo.jpg\" heigth=\"150px\"></div>\n"
                + "			<div style=\"color: #34495e; margin: 4% 10% 2%; text-align: justify;font-family: sans-serif\">\n"
                + "				<h2 style=\"color: blue; margin: 0 0 7px\">Mensaje de Activación</h2>\n"
                + "				<p style=\"margin: 2px; font-size: 15px\">\n"
                + "					" + usuario + ", para completar su registro en Clínica UNA, se necesita activar el usuario perteneciente a este correo. \n"
                + "Si no eres tú, simplemente ignora este mensaje.</p>\n"
